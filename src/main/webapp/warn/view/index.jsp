	...
	<body>
		...
		<div class="navbar navbar-inverse">
			<div class="navbar-inner">
				<a class="brand" href="javascript:void(0)" ><i class="icon-fire"></i>&nbsp;&nbsp;&nbsp;<img src="img/logo_simple.png" /></a>
		...
		<div id="sidebar-nav">
			<ul id="dashboard-menu">
				...
				<li class="left-nav-li">
					...
					<ul class="submenu">
						<li>
							<a class="func" href="userManage?method=user_sel" target="mainFrame">员工信息</a>
						</li>
					</ul>
				</li>
				<li class="left-nav-li">
		...
		<div class="content">
			<div class="frame-div">
				<iframe class="frame" id="mainFrame" name="mainFrame" src="view/fixError.jsp"></iframe>
			</div>
		</div>
