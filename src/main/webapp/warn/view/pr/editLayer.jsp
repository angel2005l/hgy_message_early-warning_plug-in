					...
					<form id="tableForm">
						...
						<div class="field-box">
							<label>*规则编码:</label> <input class="span5 inline-input"
								type="text" name="ruleCode" value="${data.ruleCode }" readonly />
						</div>
						<div class="field-box">
							<label>*规则名称:</label> <input class="span5 inline-input"
								type="text" name="ruleName" value="${data.ruleName }" placeholder="请输入规则名称..." />
						</div>
						<div class="field-box" >
							<label>*第一级推送时间</label> <input class="span5 inline-input"
								type="text" name="ruleFirstTime" value="${data.ruleFirstTime }" placeholder="请输入第一级推送时间..." />
						</div>
						<div class="field-box" >
							<label>*第二级推送时间</label> <input class="span5 inline-input"
								type="text" name="ruleSecondTime" value="${data.ruleSecondTime }" placeholder="请输入第二级推送时间..." />
						</div>
						<div class="field-box" >
							<label>*第三级推送时间</label> <input class="span5 inline-input"
								type="text" name="ruleThirdTime" value="${data.ruleThirdTime }" placeholder="请输入第三级推送时间..." />
						</div>
						<div class="field-box" >
							<label>*第四级推送时间</label> <input class="span5 inline-input"
								type="text" name="ruleFourthTime" value="${data.ruleFourthTime }" placeholder="请输入第四级推送时间..." />
						</div>
