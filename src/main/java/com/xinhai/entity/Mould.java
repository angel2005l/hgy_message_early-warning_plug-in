...
public class Mould {
	...
	private int id;//模具编号
	private int mould_factoryId;//工厂编号
	...
	public int getMould_factoryId() {
		return mould_factoryId;
	}

	public void setMould_factoryId(int mould_factoryId) {
		this.mould_factoryId = mould_factoryId;
	}
	...
	public String toString() {
		return "Mould [id=" + id + ", mould_factoryId=" + mould_factoryId + ", mouldCode=" + mouldCode + ", mouldName="
