...
import com.xinhai.task.sche.TaskSpiderMould;
import com.xinhai.task.sche.TaskSpiderMouldDevice;
import com.xinhai.task.sche.TaskSpiderWarning;
import com.xinhai.task.sche.TaskSpiderWarningType;
import com.xinhai.util.DateUtil;

public class TaskDataEntry extends TimerTask {
	...
	public void run() {
		...
		try {
			List<Task> selectTaskAll = service.selectDataTaskAll();
	...
	private void runningTask(Task task) {
		...
		try {
			...
			case "task_s_molud":
				new TaskSpiderMould();
				break;
			case "task_s_equipment":
				new TaskSpiderEquipment();
				break;
			case "task_s_warning":
				new TaskSpiderWarning();
				break;
			case "task_s_warning_type":
				new TaskSpiderWarningType();
				break;
			case "task_s_mould_device":
				new TaskSpiderMouldDevice();
				break;
			default:
				break;
			}
